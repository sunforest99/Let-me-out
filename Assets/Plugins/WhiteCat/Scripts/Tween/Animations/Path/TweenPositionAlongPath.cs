...
namespace WhiteCat.Tween
{
	...
	public class TweenPositionAlongPath : TweenFloat
	{
		...
		protected override void DrawExtraFields()
		{
			...
			if (tweener && tweener.isActiveAndEnabled && isActiveAndEnabled && moveAlongPath.isActiveAndEnabled)
			{
				EditorGUILayout.HelpBox("The MoveAlongPath should be disabled when tween system is enabled.", MessageType.Warning, false);
			}
		}
